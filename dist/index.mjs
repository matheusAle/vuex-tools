...
function createStore(options) {
    ...
    return new Store(__assign(__assign({}, options), { modules: __assign(__assign({}, ((options === null || options === void 0 ? void 0 : options.modules) || {})), modules.reduce(function (acc, _a) {
